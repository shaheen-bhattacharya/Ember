...
| [`maze.em`](maze.em) | Maze carved by iterative backtracking — a seeded Lehmer LCG, a 2D wall grid, and an array-as-stack frontier (recursion would blow the frame cap) |
